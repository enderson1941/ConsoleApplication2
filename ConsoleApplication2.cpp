...
int main()
{
	...
	//// ・ｽq・ｽX・ｽg・ｽO・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ`・ｽ謔ｷ・ｽ・ｽ・ｽ鞫懶ｿｽ・ｽ・ｽ闢厄ｿｽ・ｽ
	//const int ch_width = 260, ch_height = 200;
	//cv::Mat hist_img(cv::Size(ch_width, ch_height), CV_8UC3, cv::Scalar::all(255));

	//cv::Mat hist;
	//const int hdims[] = { 256 }; // ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽﾌヒ・ｽX・ｽg・ｽO・ｽ・ｽ・ｽ・ｽ・ｽT・ｽC・ｽY
	//const float hranges[] = { 0,256 };
	//const float* ranges[] = { hranges }; // ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽﾌビ・ｽ・ｽ・ｽﾌ会ｿｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ
	//double max_val = .0;

	//// ・ｽV・ｽ・ｽ・ｽO・ｽ・ｽ・ｽ`・ｽ・ｽ・ｽ・ｽ・ｽl・ｽ・ｽ・ｽﾌヒ・ｽX・ｽg・ｽO・ｽ・ｽ・ｽ・ｽ・ｽv・ｽZ
	//// ・ｽ鞫懶ｿｽi・ｽ・ｽ・ｽ・ｽ・ｽﾂ）・ｽC・ｽ鞫懶ｿｽ・ｽ・ｽ・ｽ・ｽC・ｽv・ｽZ・ｽ・ｽ・ｽ・ｽ・ｽ`・ｽ・ｽ・ｽ・ｽ・ｽl・ｽ・ｽ・ｽC・ｽ}・ｽX・ｽN・ｽC・ｽq・ｽX・ｽg・ｽO・ｽ・ｽ・ｽ・ｽ・ｽi・ｽo・ｽﾍ）・ｽC
	//// ・ｽq・ｽX・ｽg・ｽO・ｽ・ｽ・ｽ・ｽ・ｽﾌ趣ｿｽ・ｽ・ｽ・ｽC・ｽq・ｽX・ｽg・ｽO・ｽ・ｽ・ｽ・ｽ・ｽr・ｽ・ｽ・ｽﾌ会ｿｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ
	//cv::calcHist(&src_img, 1, 0, cv::Mat(), hist, 1, hdims, ranges);

	//// ・ｽﾅ托ｿｽ・ｽl・ｽﾌ計・ｽZ
	//cv::minMaxLoc(hist, 0, &max_val);

	//// ・ｽq・ｽX・ｽg・ｽO・ｽ・ｽ・ｽ・ｽ・ｽﾌス・ｽP・ｽ[・ｽ・ｽ・ｽ・ｽ・ｽO・ｽﾆ描・ｽ・ｽ
